...
import { TRAY_ACCOUNT_ITEMS, TRAY_CONFIGURATION_ITEMS } from "@/constants/Models";
 ...
 * @version 0.0.1
 * @component */
const ModalAccountSettingLayout = () => {
  const { tertiaryBgColor } = useThemeColors();
  const { t } = useTranslation();

  const tray = TRAY_ACCOUNT_ITEMS.find((item) => item.key === "settings");
...
export default ModalAccountSettingLayout;  